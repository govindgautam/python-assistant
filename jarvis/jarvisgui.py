...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.jarvisGUI.setGeometry(QtCore.QRect(-70, -100, 1561, 1101))
        self.jarvisGUI.setText("")
        self.jarvisGUI.setPixmap(QtGui.QPixmap("../../Downloads/2141507-3840x1080-desktop-dual-monitors-jarvis-iron-man-wallpaper-image.jpg"))
        self.jarvisGUI.setScaledContents(True)
        self.jarvisGUI.setObjectName("jarvisGUI")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(90, 580, 75, 23))
        font = QtGui.QFont()
